...
import { Text, Menu, MenuButton, MenuList, Flex, Icon, Image} from '@chakra-ui/react';
        ...
        <Menu isOpen={directoryState.isOpen} >
            <MenuButton cursor="pointer"
                ...
                <Flex align="center">
                    ...
                    <Text fontWeight={600} fontSize="10pt">{directoryState.selectedMenuItem.displayText}</Text> </Flex>
                </Flex>
                <ChevronDownIcon/>
                </Flex>
            </MenuButton>
